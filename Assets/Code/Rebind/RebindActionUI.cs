    ...
    public class RebindActionUI : MonoBehaviour
    {
        ...
        public void UpdateBindingDisplay()
        {
            ...
            if (buttonManager != null)
                buttonManager.SetText(displayString);
        ...
        private void PerformInteractiveRebind(InputAction action, int bindingIndex, bool allCompositeParts = false)
        {
            ...
            if (m_RebindOverlay == null && m_RebindText == null && m_RebindStartEvent == null && buttonManager != null)
                buttonManager.SetText("<Waiting...>");
        ...
        protected void OnEnable()
        {
            ...
            buttonManager.onClick.AddListener(StartInteractiveRebind);
        }
